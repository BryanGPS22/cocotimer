...
const Homepage = () => {
  ...
  return (
    <div>
      <div
        className={`relative bg-cover bg-no-repeat bg-center w-full p-6 md:py-20 py-20`}
        style={{
      ...
      >
        <div className="relative w-full p-6 py-10 rounded-2xl">
          <div className="text-center">
            <div className="flex items-center justify-center text-white gap-2 md:mt-12 mb-8 md:text-[28px] text-[22px]">
              {task && task.title}
            </div>
            <p
              className="font-alarm-clock text-[50px] md:text-[160px] text-[#ff9100] text-center leading-none"
              style={{ color: selectedColor }}
            >
              {formatTime(seconds)}
            </p>

            <div className="flex justify-center md:gap-[330px] gap-[60px] ">
                  ...
                  <div className="bg-white/30 backdrop-blur-lg rounded-md max-w-[400px] w-full transition-transform ease-out duration-300 relative">
                    ...
                    <div className="relative overflow-y-auto max-h-[80vh] p-5">
                      <div className=" container md:w-full w-full">
                        <div className="">
                          <p className="text-[20px] text-start font-semibold text-white mb-3">
                            Focus Theme
                          </p>
